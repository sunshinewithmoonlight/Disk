    ...
    for (_, i__lninputInt) in l__db2_lnInputInt.enumerated() {
        for (v_2__index, v_3__elem) in l0_remaining.enumerated() {
            if v_3__elem == i__lninputInt {
                ...
                /*
                if (i__lninputInt%19 - 19 < 4 && 19 - i__lninputInt%19 < 4) || (i__lninputInt/19 - 19 < 4 && 19 - i__lninputInt/19 < 4) {
                    for (i__lninputInt_aroundIndex, i__lninputInt_around) in l_db4.enumerated() {
                        if (i__lninputInt_around%19 - i__lninputInt > 5 || i__lninputInt_around%19 - i__lninputInt < -5) {
                            l_db4.remove(at:i__lninputInt_aroundIndex)
                        }
                        if (i__lninputInt_around < 0 || i__lninputInt_around > 360) {
                            l_db4.remove(at:i__lninputInt_aroundIndex)
                        }
                    }
                }
    ...
    if var__db1_mode == "func_e__countWinTimes" {
        ...
        for (v_2__index, v_3__elem) in l0_remaining.enumerated() {
            if v_3__elem == var__db4_next[1] {
                ...
                l_db4 = [nIndex-60, nIndex-59, nIndex-58, nIndex-57, nIndex-56, nIndex-55, nIndex-54, nIndex-41, nIndex-40, nIndex-39, nIndex-38, nIndex-37, nIndex-36, nIndex-35, nIndex-22, nIndex-21, nIndex-20, nIndex-19, nIndex-18, nIndex-17, nIndex-16,nIndex-3, nIndex-2, nIndex-1, nIndex-76, nIndex-80, nIndex-72, nIndex-4, nIndex+60, nIndex+59, nIndex+58, nIndex+57, nIndex+56, nIndex+55, nIndex+54, nIndex+41, nIndex+40, nIndex+39, nIndex+38, nIndex+37, nIndex+36, nIndex+35, nIndex+22, nIndex+21, nIndex+20, nIndex+19, nIndex+18, nIndex+17, nIndex+16, nIndex+3, nIndex+2, nIndex+1, nIndex+76, nIndex+80, nIndex+72, nIndex+4]
                /*
                if (nIndex%19 - 19 < 4 && 19 - nIndex%19 < 4) || (nIndex/19 - 19 < 4 && 19 - nIndex/19 < 4) {
                    for (nIndex_aroundIndex, nIndex_around) in l_db4.enumerated() {
                        if (nIndex_around%19 - nIndex > 5 || nIndex_around%19 - nIndex < -5) {
                            l_db4.remove(at:nIndex_aroundIndex)
                        }
                        if (nIndex_around < 0 || nIndex_around > 360) {
                            l_db4.remove(at:nIndex_aroundIndex)
                        }
                    }
                }
...
//            l_db3__aroundIndex = Array(Set(l_db3__aroundIndex))
            ...
            l_db4 = [mIndex-60, mIndex-59, mIndex-58, mIndex-57, mIndex-56, mIndex-55, mIndex-54, mIndex-41, mIndex-40, mIndex-39, mIndex-38, mIndex-37, mIndex-36, mIndex-35, mIndex-22, mIndex-21, mIndex-20, mIndex-19, mIndex-18, mIndex-17, mIndex-16,mIndex-3, mIndex-2, mIndex-1, mIndex-76, mIndex-80, mIndex-72, mIndex-4, mIndex+60, mIndex+59, mIndex+58, mIndex+57, mIndex+56, mIndex+55, mIndex+54, mIndex+41, mIndex+40, mIndex+39, mIndex+38, mIndex+37, mIndex+36, mIndex+35, mIndex+22, mIndex+21, mIndex+20, mIndex+19, mIndex+18, mIndex+17, mIndex+16, mIndex+3, mIndex+2, mIndex+1, mIndex+76, mIndex+80, mIndex+72, mIndex+4]
            /*
            if (mIndex%19 - 19 < 4 && 19 - mIndex%19 < 4) || (mIndex/19 - 19 < 4 && 19 - mIndex/19 < 4) {
                for (mIndex_aroundIndex, mIndex_around) in l_db4.enumerated() {
                    if (mIndex_around%19 - mIndex > 5 || mIndex_around%19 - mIndex < -5) {
                        l_db4.remove(at:mIndex_aroundIndex)
                    }
                    if (mIndex_around < 0 || mIndex_around > 360) {
                        l_db4.remove(at:mIndex_aroundIndex)
                    }
                }
            }
...
func func_e__countWinTimes (var__de1_sum : Int, var__de2_obj : Character, var__de3_lmInputInt : [Int], var__de4_lnInputInt : [Int], var__de5_ifAutoSave : Bool = true) {
    ...
    var v__de2 = 0
    var l_db4 = [Int]()
    var l_de3__aroundIndex = [Int]()
    print(var__de3_lmInputInt, var__de4_lnInputInt)

    for (_, i__lninputInt) in var__de4_lnInputInt.enumerated() {
        l_db4 = [i__lninputInt-60, i__lninputInt-59, i__lninputInt-58, i__lninputInt-57, i__lninputInt-56, i__lninputInt-55, i__lninputInt-54, i__lninputInt-41, i__lninputInt-40, i__lninputInt-39, i__lninputInt-38, i__lninputInt-37, i__lninputInt-36, i__lninputInt-35, i__lninputInt-22, i__lninputInt-21, i__lninputInt-20, i__lninputInt-19, i__lninputInt-18, i__lninputInt-17, i__lninputInt-16,i__lninputInt-3, i__lninputInt-2, i__lninputInt-1, i__lninputInt-76, i__lninputInt-80, i__lninputInt-72, i__lninputInt-4, i__lninputInt+60, i__lninputInt+59, i__lninputInt+58, i__lninputInt+57, i__lninputInt+56, i__lninputInt+55, i__lninputInt+54, i__lninputInt+41, i__lninputInt+40, i__lninputInt+39, i__lninputInt+38, i__lninputInt+37, i__lninputInt+36, i__lninputInt+35, i__lninputInt+22, i__lninputInt+21, i__lninputInt+20, i__lninputInt+19, i__lninputInt+18, i__lninputInt+17, i__lninputInt+16, i__lninputInt+3, i__lninputInt+2, i__lninputInt+1, i__lninputInt+76, i__lninputInt+80, i__lninputInt+72, i__lninputInt+4]
        /*
        if (i__lninputInt%19 - 19 < 4 && 19 - i__lninputInt%19 < 4) || (i__lninputInt/19 - 19 < 4 && 19 - i__lninputInt/19 < 4) {
            for (i__lninputInt_aroundIndex, i__lninputInt_around) in l_db4.enumerated() {
                if (i__lninputInt_around%19 - i__lninputInt > 5 || i__lninputInt_around%19 - i__lninputInt < -5) {
        ...
        */
        l_de3__aroundIndex += l_db4
    }
    for (_, i__lminputInt) in l_de3__aroundIndex.enumerated() {
        l_db4 = [i__lminputInt-60, i__lminputInt-59, i__lminputInt-58, i__lminputInt-57, i__lminputInt-56, i__lminputInt-55, i__lminputInt-54, i__lminputInt-41, i__lminputInt-40, i__lminputInt-39, i__lminputInt-38, i__lminputInt-37, i__lminputInt-36, i__lminputInt-35, i__lminputInt-22, i__lminputInt-21, i__lminputInt-20, i__lminputInt-19, i__lminputInt-18, i__lminputInt-17, i__lminputInt-16,i__lminputInt-3, i__lminputInt-2, i__lminputInt-1, i__lminputInt-76, i__lminputInt-80, i__lminputInt-72, i__lminputInt-4, i__lminputInt+60, i__lminputInt+59, i__lminputInt+58, i__lminputInt+57, i__lminputInt+56, i__lminputInt+55, i__lminputInt+54, i__lminputInt+41, i__lminputInt+40, i__lminputInt+39, i__lminputInt+38, i__lminputInt+37, i__lminputInt+36, i__lminputInt+35, i__lminputInt+22, i__lminputInt+21, i__lminputInt+20, i__lminputInt+19, i__lminputInt+18, i__lminputInt+17, i__lminputInt+16, i__lminputInt+3, i__lminputInt+2, i__lminputInt+1, i__lminputInt+76, i__lminputInt+80, i__lminputInt+72, i__lminputInt+4]
        /*
        a0 = 
        a1 = 
        ...
        ...
        switch(mnindex){
        case 0:
        l_db4 = list4 + list5 + list6 + list7 + list8
        break;
        case 1:
        l_db4 = list3 + list4 + list5 + list6 + list7 + list8
        break;
        case 2:
        l_db4 = list2 + list3 + list4 + list5 + list6 + list7 + list8
        break;
        case 3:
        l_db4 = list1 + list2 + list3 + list4 + list5 + list6 + list7 + list8
        break;
        case 15:
        l_db4 = l_db4 + list1 + list2 + list3 + list4 + list5 + list6 + list7
        break;
        case 16:
        l_db4 = l_db4 + list1 + list2 + list3 + list4 + list5 + list6
        break;
        case 17:
        l_db4 = l_db4 + list1 + list2 + list3 + list4 + list5
        break;
        case 18:
        l_db4 = l_db4 + list1 + list2 + list3 + list4
        break;
        default:
        l_db4 = l_db4 + list1 + list2 + list3 + list4 + list5 + list6 + list7 + list8
        break;
        }
        for (l_db4Elem_index ,l_db4Elem) in l_db4.enumerated() {
            if (l_db4Elem < 0 || l_db4Elem > 360) {
                l_db4.remove(at:l_db4Elem_index)
            }
        }
    ...
    l_de3__aroundIndex = Array(Set(l_de3__aroundIndex))
    for (i_de9__index, i_de9) in l_de3__aroundIndex.enumerated() {
        if i_de9 < 0 {
            l_de3__aroundIndex.remove(at:i_de9__index)
        }
    }
    let i__de5 = var__de1_sum*(l_de3__aroundIndex.count - var__de3_lmInputInt.count - var__de4_lnInputInt.count)

    if var__de3_lmInputInt.count == var__de4_lnInputInt.count {
        for i__de2 in 0..<var__de1_sum {
            print("    "+String(i__de5/var__de1_sum*i_de10)+"    /    "+String(i__de5)+"       "+String(i__de2)+"  done              "+"\r")
            for i__de1 in l_de3__aroundIndex {
...
//                (v__de1, v__de2) = func_b__perRoundnFirst(var__db1_mode:"func_e__countWinTimes", var__db2_ifEnvAndroid:false, l__db1_lmInputInt:var__de3_lmInputInt, l__db2_lnInputInt:var__de4_lnInputInt, var__db4_next:l__de2_next)
        ...
        for i__de4 in 0..<var__de1_sum {
            print("    "+String(i__de5/var__de1_sum*i_de10)+"    /    "+String(i__de5)+"       "+String(i__de4)+"  done              "+"\r")
            for i__de3 in l_de3__aroundIndex {
...
*/
    ...
    print("    "+String(i__de5)+"    /    "+String(i__de5)+"       "+String(var__de1_sum)+"  done"+"\r")
    print(l__de1)
    ...
    print(String(i__de8/Double(i__de5)))
    print()
}

var lmInput = [[9, 9], [10, 9], [11, 9]]
var lnInput = [[8, 8], [11, 11]]
