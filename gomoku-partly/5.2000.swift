...
func func_b__perRound (var__db1_mode:String = "Normal", var__db2_ifEnvAndroid:Bool = false, l__db1_lmInputInt:[Int], l__db2_lnInputInt:[Int], var__db3_obj:Character = "m", var__db4_next:[Int] = [0, -1], l0:[Int] = l0) -> (Int, Int) {
    ...
    for (_, i__lminputInt) in l__db1_lmInputInt.enumerated() {
        ...
        for (v_2__index, v_3__elem) in l0.enumerated() {
    ...
    if var__db1_mode == "func_e__countWinTimes" {
        ...
        for (v_2__index, v_3__elem) in l0_remaining.enumerated() {
            if v_3__elem == var__db4_next[1] {
                l0_remaining.remove(at:v_2__index)
                lnindex.append(var__db4_next[1])
                l__sqare[Int(var__db4_next[1]/19)][var__db4_next[1]%19] = "n"
                if func_ifWin(var_a__position:[Int(var__db4_next[1]/19), var__db4_next[1]%19], obj:"n", l__sqare:l__sqare) == "n" {
                    if var__db4_next[0] == 1 {
                        return (1, 1) }
                    if var__db4_next[0] == 0 {
                        return (0, 1) } }
                l_db4 = [var__db4_next[1]-60, var__db4_next[1]-59, var__db4_next[1]-58, var__db4_next[1]-57, var__db4_next[1]-56, var__db4_next[1]-55, var__db4_next[1]-54, var__db4_next[1]-41, var__db4_next[1]-40, var__db4_next[1]-39, var__db4_next[1]-38, var__db4_next[1]-37, var__db4_next[1]-36, var__db4_next[1]-35, var__db4_next[1]-22, var__db4_next[1]-21, var__db4_next[1]-20, var__db4_next[1]-19, var__db4_next[1]-18, var__db4_next[1]-17, var__db4_next[1]-16,var__db4_next[1]-3, var__db4_next[1]-2, var__db4_next[1]-1, var__db4_next[1]-76, var__db4_next[1]-80, var__db4_next[1]-72, var__db4_next[1]-4, var__db4_next[1]+60, var__db4_next[1]+59, var__db4_next[1]+58, var__db4_next[1]+57, var__db4_next[1]+56, var__db4_next[1]+55, var__db4_next[1]+54, var__db4_next[1]+41, var__db4_next[1]+40, var__db4_next[1]+39, var__db4_next[1]+38, var__db4_next[1]+37, var__db4_next[1]+36, var__db4_next[1]+35, var__db4_next[1]+22, var__db4_next[1]+21, var__db4_next[1]+20, var__db4_next[1]+19, var__db4_next[1]+18, var__db4_next[1]+17, var__db4_next[1]+16, var__db4_next[1]+3, var__db4_next[1]+2, var__db4_next[1]+1, var__db4_next[1]+76, var__db4_next[1]+80, var__db4_next[1]+72, var__db4_next[1]+4]
                l_db3__aroundIndex += l_db4
...
func func_e__countWinTimes (var__de1_sum : Int, var__de2_obj : Character, var__de3_lmInputInt : [Int], var__de4_lnInputInt : [Int], var__de5_ifAutoSave : Bool = true) {
    ...
    for (_, i__lminputInt) in var__de3_lmInputInt.enumerated() {
        l_db4 = [i__lminputInt-60, i__lminputInt-59, i__lminputInt-58, i__lminputInt-57, i__lminputInt-56, i__lminputInt-55, i__lminputInt-54, i__lminputInt-41, i__lminputInt-40, i__lminputInt-39, i__lminputInt-38, i__lminputInt-37, i__lminputInt-36, i__lminputInt-35, i__lminputInt-22, i__lminputInt-21, i__lminputInt-20, i__lminputInt-19, i__lminputInt-18, i__lminputInt-17, i__lminputInt-16,i__lminputInt-3, i__lminputInt-2, i__lminputInt-1, i__lminputInt-76, i__lminputInt-80, i__lminputInt-72, i__lminputInt-4, i__lminputInt+60, i__lminputInt+59, i__lminputInt+58, i__lminputInt+57, i__lminputInt+56, i__lminputInt+55, i__lminputInt+54, i__lminputInt+41, i__lminputInt+40, i__lminputInt+39, i__lminputInt+38, i__lminputInt+37, i__lminputInt+36, i__lminputInt+35, i__lminputInt+22, i__lminputInt+21, i__lminputInt+20, i__lminputInt+19, i__lminputInt+18, i__lminputInt+17, i__lminputInt+16, i__lminputInt+3, i__lminputInt+2, i__lminputInt+1, i__lminputInt+76, i__lminputInt+80, i__lminputInt+72, i__lminputInt+4]
        l_de3__aroundIndex += l_db4
    }
...
/*
            ...
            createFile(path: String, data: Data?)
